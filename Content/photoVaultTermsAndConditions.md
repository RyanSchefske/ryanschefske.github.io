...
- Album organization, import from the photo library, camera capture, and export
- Optional Pro features, including unlimited storage capacity, video support, unlimited albums, a decoy vault, lock-screen and app-icon disguises, break-in reports, face-down lock, and end-to-end encrypted iCloud backup
...
- **You are solely responsible** for remembering your passcode and for storing your recovery code in a safe place outside the App.
...
- Store, hide, or distribute any content that is illegal under applicable law, including content that exploits or endangers minors
- Infringe the intellectual property, privacy, or publicity rights of others
- Conceal evidence of, or facilitate, criminal activity
- Circumvent another person's lawful right of access to data (for example, hiding records subject to legal preservation obligations)
